...
const NewAdd = () => {
    ...
    const handleSubmit  = (e) => {
        ...
        if (!submitData.description || submitData.description.trim() === '') {
            submitData.description = generateDescription('news', submitData.name);
        }
        dispatch(actions.addNew(submitData))
    }
        ...
        <div className="full pt-5">
            <div className="w-full px-4 sm:px-6 md:px-[30px] flex gap-4 sm:gap-8">
                <div className="w-full">
                    ...
                    <h2 className="text-xl sm:text-2xl md:text-[35px] font-semibold mt-3 sm:mt-0">Thêm mới new</h2>
                </div>
            </div>
