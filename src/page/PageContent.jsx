        ...
        <div className="full pt-3 sm:pt-5">
            ...
            <div className="w-full px-4 sm:px-6 md:px-[30px] flex gap-4 sm:gap-8">
                <div className="w-full">
                    ...
                    <h2 className="text-xl sm:text-2xl md:text-[35px] font-semibold mt-3 sm:mt-5">Quản lý trang nội dung</h2>
                </div>
            </div>
                        ...
                        <tbody>
                            {contents && contents?.length > 0 ? currentContent?.map((item, index) => (
                                ...
                                >
                                    ...
                                    <th scope="row" className="px-2 sm:px-4 py-2 sm:py-4 font-medium text-xs sm:text-sm text-gray-900 dark:text-white w-3/11">
                                        <NavLink 
                                            to={`/page-content/${item._id}`} 
                                            className="line-clamp-2 text-blue-500"
                                        >
                                            {item.name}
                                        </NavLink>
                                    </th>
                                    <td className="px-2 sm:px-4 py-2 sm:py-4 w-3/11 text-xs sm:text-sm hidden md:table-cell">
                                        <span className="line-clamp-1">{item.slug}</span>
                                    </td>
                                    <td className="py-2 sm:py-4 w-1/10 hidden sm:table-cell">
                                        <div className="w-full">
                                            {item.image ? (
                                                <img 
                                    ...
                                    <td className="px-2 sm:px-4 py-2 sm:py-4 w-1/11">
                                        {
                                            item.duyet === 'Yes' && 
                                    ...
                                    <td className="px-2 sm:px-4 py-2 sm:py-4 w-1/11 text-[10px] sm:text-xs hidden lg:table-cell">
                                        {item.formatDate}
                                    </td>
