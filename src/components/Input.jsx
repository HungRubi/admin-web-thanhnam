    ...
    return (
        <div className="mt-4 sm:mt-5">
            ...
            <div className="mt-2">
                ...
                className={`focus:ring-blue-500! focus:border-blue-500! block grow py-1.5 px-2.5 sm:px-3 text-sm sm:text-base text-gray-900 placeholder:text-gray-400 border-custom w-full sm:w-2/3 rounded-lg ${className}`}/>
            </div>
        </div>
